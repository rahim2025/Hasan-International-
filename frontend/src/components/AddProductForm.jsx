...
import { Camera, Package, FileText, ToggleLeft, ToggleRight, DollarSign, Phone } from "lucide-react";
...
const AddProductForm = ({ product, onSuccess, onCancel }) => {
    ...
    }, [product]);    const handleImageUpload = (e) => {
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            onChange={handleInputChange}
                            className="input input-bordered w-full pl-10"
                            placeholder="Enter any contact phone number"
                            disabled={isCreating}
                        />
                    </div>
                    <p className="text-xs text-base-content/60">
                        Optional: Any phone number format accepted (mobile, landline, international)
                    </p>
                </div>
