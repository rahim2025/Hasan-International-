...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    },
    {
      ...
      title: "Phone & Contact",
      details: [        "Phone: +880 1819017294, +8801842151098",
        "Email: hasanin1950@gmail.com",
        "Website: www.hasanchemicalbd.com"
      ]
    },
    {
  ...
  return (
    <>      <SEO 
        title="Contact Us - Hasan International - Get in Touch"
        description="Contact Hasan International - Your trusted chemical supply partner since 1958. Located in Armanitola, Dhaka, Bangladesh. Get quotes, technical support, and product information."
        keywords="contact hasan international, chemical company contact bangladesh, dhaka office, chemical supplier contact, bangladesh chemicals"
        url="https://www.hasanchemicalbd.com/contact"
      />
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-700 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            Get in touch with our experienced team. We're here to help with all your chemical supply needs and provide authentic solutions since 1958.
          </motion.p>
        </div>
      </section>
