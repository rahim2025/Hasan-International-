...
const ProductDetailPage = () => {
    ...
    // Handle hash-based navigation (e.g., #comments)
    useEffect(() => {
            ...
            if (hash && product) {
                ...
                setTimeout(() => {
                    ...
                    if (element) {
                        ...
                        setActiveTab(hash); // Set the active tab to match the hash
                    }
                }, 100);
            }
        };

        // Check for hash when component mounts or when product changes
        if (product) {
                                    ...
                                    {product.contactPhone && (
                                        <div className="bg-green-50 rounded-lg p-5 border border-green-200">
                                            <div className="flex items-center gap-2 mb-2">
                                                ...
                                                <h3 className="text-lg font-semibold text-green-800">Contact Seller</h3>
                                            </div>
                                            <a 
                                                href={`tel:${product.contactPhone}`}
                                                className="text-xl font-bold text-green-700 hover:text-green-800 hover:underline transition-colors flex items-center gap-2"
                                            >
                                                <Phone size={16} />
                                                {product.contactPhone}
                                            </a>
                        ...
                        <div id="specifications" className="bg-base-100 rounded-xl shadow-lg p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    {product.contactPhone && (
                                        <div className="grid grid-cols-2 border-b border-base-200 pb-2">
                                            <span className="text-base-content/70 font-medium">Contact Phone</span>
                                            <a 
                                                href={`tel:${product.contactPhone}`}
                                                className="font-semibold text-green-600 hover:text-green-800 hover:underline flex items-center gap-1"
                                            >
                                                <Phone size={14} />
                                                {product.contactPhone}
                                            </a>
