...
import { Plus, Edit, Trash2, Package, MessageCircle, Search, Mail, Phone } from "lucide-react";
    ...
    return (
        <>
            <SEO 
                ...
                url="https://www.hasanchemicalbd.com/products"
            />
            <div className="min-h-screen bg-base-200 pt-20">
            <div className="container mx-auto px-4">
                            ...
                            <div key={product._id} className="card bg-base-100 shadow-sm hover:shadow-md transition-all duration-300 group border border-base-200 rounded-xl overflow-hidden">
                                ...
                                <div className="card-body p-2.5">
                                    ...
                                    {product.contactPhone && (
                                        <div className="mt-1 p-1.5 bg-green-50 rounded-lg border border-green-200">
                                            <div className="text-[9px] text-green-600 uppercase tracking-wide mb-0.5 font-medium">Contact</div>
                                            <a 
                                    ...
                                    <div className="flex items-center justify-between mt-1.5">                                        {/* Reviews Button - Clickable */}
                                        <div className="flex items-center text-[9px]">
                                            <div className="tooltip tooltip-top" data-tip="View Reviews & Comments">
                                                <Link 
                                                    ...
                                                    className="flex items-center gap-1 bg-primary/10 text-primary px-2 py-0.5 rounded-full border border-primary/20 hover:bg-primary/20 transition-all duration-300 group-hover:scale-105 cursor-pointer"
                                                >
